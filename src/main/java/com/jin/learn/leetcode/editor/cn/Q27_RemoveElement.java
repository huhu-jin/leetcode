...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public void testCase(){
        Assert.assertEquals(1,new Solution().removeElement(new int[]{4}, 3));
        Assert.assertEquals(0,new Solution().removeElement(new int[]{3,3}, 3));
        Assert.assertEquals(4,new Solution().removeElement(new int[]{1, 2, 3, 4, 3, 5}, 3));
    }
