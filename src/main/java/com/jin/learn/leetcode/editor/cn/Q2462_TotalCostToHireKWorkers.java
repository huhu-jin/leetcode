...
// 
//
// Related Topics 数组 双指针 模拟 堆（优先队列） 👍 41 👎 0
...
import java.util.PriorityQueue;
 ...
 public class Q2462_TotalCostToHireKWorkers{
  
//如何理解 : 从最前面 candidates 和最后面 candidates 人中选出代价最小的一位工人
//[17,12,10,2,7,2,11,20,8], candidates =4
//只能在前4个(17,12,10,2) 后面4个(2,11,20,8)中选, 即不能选 7
    ...
    public long totalCost(int[] costs, int k, int candidates) {
        ...
        if (l < r) {
            for (int i = 0; i < candidates; i++) {
                ...
                queue.add(new int[]{costs[costs.length-1-i], costs.length-1-i});
            }
        }else {
